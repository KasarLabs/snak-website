...
export default function AgentForm() {
  ...
  return (
    <div className="w-full max-w-2xl bg-neutral-900 rounded-lg shadow-lg border border-neutral-800 flex flex-col h-[80vh]">
              ...
              {allPlugins.map((plugin) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12 rounded-full bg-neutral-700 overflow-hidden">
                      <Image
                        src={plugin.image}
                        alt={plugin.name}
                        fill
